  ...
  describe "#get_data" do
    ...
    describe "the returned hash" do
      it "contains a hash for the refund" do
        ...
        expect(subject.get_data).to include(subject.refund.to_hash)
      end

      it "contains the payment_id" do
        subject.payment_id = "payment_id"
        expect(subject.get_data).to include(payment_id: "payment_id")
      end

      it "contains the ems_url when it exists" do
        expect(subject.get_data).to_not include(ems_url: nil)
