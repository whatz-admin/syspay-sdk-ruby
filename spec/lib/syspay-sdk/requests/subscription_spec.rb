  ...
  describe '#data' do
    ...
    describe 'the returned hash' do
      ...
      it 'contains a hash for the subscription' do
        ...
        expect(subject.data).to include(subscription: subscription.to_hash)
      end
      ...
      it 'contains the method' do
        ...
        expect(subject.data).to include(method: 'method')
      end
      ...
      it 'contains the use_subscription' do
        ...
        expect(subject.data).to include(use_subscription: true)
      end

      it 'contains the use_billing_agreement' do
        subject.use_billing_agreement = true
        expect(subject.data).to include(use_billing_agreement: true)
      end
    end
  end
end
